function[] = plot_spectrum()
    ...
    hold on
    semilogy(x, ratios_processed(1, :), '', 'Color', 'red', "MarkerSize", 18,'LineWidth', 1.8)
    hold on
    semilogy(x, ratios_processed(2, :), '', 'Color', 'blue', "MarkerSize", 18,'LineWidth', 1.0)
